...
class PlanoDiamante extends StatefulWidget {
  @override
  _PlanoDiamanteState createState() => _PlanoDiamanteState();
}

class _PlanoDiamanteState extends State<PlanoDiamante> {
        ...
        Column(
          children: [
            Expanded(
              child: Column(
                children: <Widget>[
                  Text('Diamante', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  Divider(),
                  Text('399,90', style: TextStyle(color: Colors.grey[350], fontSize: 30), textAlign: TextAlign.center,),
                  Text('Por Ano', style: TextStyle(color: Colors.grey[350], fontSize: 20), textAlign: TextAlign.center,),
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Peça Ja', style: TextStyle(color: Colors.white),), onTap: _launchURL,))
                  ),
                ]
              ),
            )
