...
import 'planobronze.dart';
import 'planodiamante.dart';


class PerguntaSite4a extends StatefulWidget {
  @override
  _PerguntaSite4aState createState() => _PerguntaSite4aState();
}

class _PerguntaSite4aState extends State<PerguntaSite4a> {
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Seu site tera e-commerce (comercio eletrônico)?', style: TextStyle(color: Colors.white, fontSize: 30), textAlign: TextAlign.center,),
                  ),    
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Sim', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PlanoDiamante()));},),),
                  ),   
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Não', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PlanoBronze()));},),),
                  ), 
                ]
              ),
            ),
