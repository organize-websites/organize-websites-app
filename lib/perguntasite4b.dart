...
import 'planoprata.dart';


class PerguntaSite4b extends StatefulWidget {
  @override
  _PerguntaSite4bState createState() => _PerguntaSite4bState();
}

class _PerguntaSite4bState extends State<PerguntaSite4b> {
            ...
            Container(
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Não', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PlanoPrata()));},),),
                  ), 
                ]
              ),
            ),
