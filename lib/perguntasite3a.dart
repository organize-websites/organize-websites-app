...
import 'perguntasite4a.dart';
import 'perguntasite4b.dart';


class PerguntaSite3a extends StatefulWidget {
  @override
  _PerguntaSite3aState createState() => _PerguntaSite3aState();
}

class _PerguntaSite3aState extends State<PerguntaSite3a> {
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Todos os nossos sites são responsivos / Mobile, possuem design personalizavel e painel administrativo, agora precisamos saber quantas paginas aproximadamente você acredita que terão em seu site?', style: TextStyle(color: Colors.white, fontSize: 30), textAlign: TextAlign.center,),
                  ),    
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Uma', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaSite4a()));},),),
                  ),   
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Entre duas e sete paginas', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaSite4a()));},),),
                  ),  
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Mais de sete paginas', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaSite4b()));},),),
                  ), 
                ]
              ),
            ),
