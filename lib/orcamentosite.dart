...
import 'perguntasite1.dart';


class OrcamentoSite extends StatefulWidget {
  @override
  _OrcamentoSiteState createState() => _OrcamentoSiteState();
}

class _OrcamentoSiteState extends State<OrcamentoSite> {
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('A seguir você respondera algumas perguntas, que resultarão no valor do seu orçamento!', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  ),                  
                ]
              ),
            ),
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Continuar', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaSite1()));},),),
                  ),
                ]
              ),
            )
