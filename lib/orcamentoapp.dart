...
class OrcamentoApp extends StatefulWidget {
  @override
  _OrcamentoAppState createState() => _OrcamentoAppState();
}

class _OrcamentoAppState extends State<OrcamentoApp> {
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('Ainda não temos o orçamento disponivel por aqui, mas fique a vontade para fazer o orçamento pelo WhatsApp, clique no botão abaixo!', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  ),                  
                ]
              ),
            ),
