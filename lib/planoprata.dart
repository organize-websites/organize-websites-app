...
class PlanoPrata extends StatefulWidget {
  @override
  _PlanoPrataState createState() => _PlanoPrataState();
}

class _PlanoPrataState extends State<PlanoPrata> {
        ...
        Column(
          children: [
            Expanded(
              child: Column(
                children: <Widget>[
                  Text('Prata', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  Divider(),
                  Text('229,90', style: TextStyle(color: Colors.grey[350], fontSize: 30), textAlign: TextAlign.center,),
