...
class PlanoBronze extends StatefulWidget {
  @override
  _PlanoBronzeState createState() => _PlanoBronzeState();
}

class _PlanoBronzeState extends State<PlanoBronze> {
        ...
        Column(
          children: [
            Expanded(
              child: Column(
                children: <Widget>[
                  Text('Bronze', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  Divider(),
                  Text('179,90', style: TextStyle(color: Colors.grey[350], fontSize: 30), textAlign: TextAlign.center,),
