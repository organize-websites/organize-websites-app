...
class PlanoOuro extends StatefulWidget {
  @override
  _PlanoOuroState createState() => _PlanoOuroState();
}

class _PlanoOuroState extends State<PlanoOuro> {
        ...
        Column(
          children: [
            Expanded(
              child: Column(
                children: <Widget>[
                  Text('Ouro', style: TextStyle(color: Colors.white, fontSize: 40), textAlign: TextAlign.center,),
                  Divider(),
                  Text('299,90', style: TextStyle(color: Colors.grey[350], fontSize: 30), textAlign: TextAlign.center,),
