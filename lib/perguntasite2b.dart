...
class PerguntaSite2b extends StatefulWidget {
  @override
  _PerguntaSite2bState createState() => _PerguntaSite2bState();
}

class _PerguntaSite2bState extends State<PerguntaSite2b> {
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Sim', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PerguntaSite3b()));},),),
                  ),   
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
