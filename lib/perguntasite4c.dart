...
import 'planoouro.dart';


class PerguntaSite4c extends StatefulWidget {
  @override
  _PerguntaSite4cState createState() => _PerguntaSite4cState();
}

class _PerguntaSite4cState extends State<PerguntaSite4c> {
            ...
            Container(
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 15, left: 20, right: 20, bottom: 15),
                    child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: Color.fromRGBO(234, 85, 15, 1.0)), child: ListTile(leading: Icon(Icons.keyboard_arrow_right, color: Colors.white,), title: Text('Não', style: TextStyle(color: Colors.white),), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => PlanoOuro()));},),),
                  ), 
                ]
              ),
            ),
